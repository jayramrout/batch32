...
public class ExceptionExample_CatchFinally {
    public static void main(String[] args) {
        ...
        try {
            firstResult = computeFirstResult2(firstValue, secondValue, intValues);
        }finally {
            System.out.println("This is the final piece of code....");
        }
    ...
    public static int computeFirstResult2(int firstValue, int secondValue , int intValues[]) throws RuntimeException {
        int firstResult;
        if(secondValue == 0) {
            throw new RuntimeException("The Value "+ secondValue +" cannot be zero");
        }
